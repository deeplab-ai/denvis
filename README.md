...
* [PDBBind v.2019 general set](https://storage.googleapis.com/denvis_v1_data/pdbbind_v2019_general.tar.gz) (4.6G) (model training)
* [PDBBind v.2019 refined set](https://storage.googleapis.com/denvis_v1_data/pdbbind_v2019_refined.tar.gz) (1G) (model training)
* [PDBBind v.2019 core set](https://storage.googleapis.com/denvis_v1_data/pdbbind_v2019_core.tar.gz) (68M) (model validation)
* [TOUGH-M1](https://storage.googleapis.com/denvis_v1_data/tough_m1.tar.gz) (895M) (model pre-training)
* [DUD-E](https://storage.googleapis.com/denvis_v1_data/dude.tar.gz) (23M) (model validation / benchmark)
...
It is recommended that you run `download_extract_data.sh` to download and extract all output data/scores used in the benchmark.
...
### Note #1
GNINA, RF-score and NN-score scoring outputs for DUD-E are provided by [David Koes Lab](http://bits.csb.pitt.edu/) (original links provided above).
